...
app.use("/ariza", require("./router/ariza/ariza"));
app.use("/universitet", require("./router/ariza/universitet"));
app.use("/yonalish", require("./router/ariza/yonalish"));
app.use("/davlat", require("./router/ariza/country"));
app.use("/videoAdd", require("./router/ariza/video"));
